      ...
      <div className='wrapper'>
           ...
           <UserboardHeader/>
            ...
            <div className='container'>
                 <div className='slot-grid-box'>
                    <div className='slot-grid-item'>
                        <h2 className='slot-heading'>List Of Service</h2>
                        <div className='slot-grid-card-box'>
                            <div className='slot-card-item'>
                                 ...
                                 <div className='slot-card-footer'>
                                   <div className='slot-amount'>Amount</div>
