...
import EmployeeCompletedCard from '../components/EmployeeCompletedCard';
            ...
            <div className='page-body'>
             <div className='booking-menu-box'>
                ...
                <li className='booking-menu-item '><Link to="/employee-booking-list" className='booking-menu-link'>Booking List</Link></li>
                    <li className='booking-menu-item booking-active-menu'><Link to="/employee-booking-completed" className='booking-menu-link'>Completed</Link></li>
